...
const STRIPE_PRICE_ID_ELITE = "price_1S27l1G1gLpUu4C4Jd0vIePN"; // sostituisci con il tuo ID Stripe reale

export function Abbonamenti({ promoCodeInput, setPromoCodeInput, promoCodeValid, loading, handleCheckout }: AbbonamentiProps) {
